...
class userEntryJunction {

    static deleteUserEntryJunction(req, res, next) {
        userEntryJunctionSchema.deleteOne({user: req.body.user, entry: req.body.entry}).then(() => {
            res.status(200).send({
                success: true,
    ...
    static saveUserEntryJunction(req, res, next) {
        new userEntryJunctionSchema({user: req.body.user, entry: req.body.entry}).save().then(() => {
            res.status(200).send({
                success: true,
...
module.exports = userEntryJunction
